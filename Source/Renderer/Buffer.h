...
namespace Renderer
{
	...
	public:
		...
		void drawInstanced(GLint base, int instances, std::vector<glm::mat4> *inMats, std::vector<glm::mat3> *normalMats, float *color = nullptr, uint32_t *IDs = nullptr);
	...
	private:
		...
		GLuint m_inMatVBO, m_normalMatVBO, m_colorVBO, m_IDsVBO;
		GLsizei m_Count;
	};
}
